...
export const metadata: Metadata = {
  title: "John's Blog | Thoughts & Tutorials",
  description: 'A personal blog about web development, SEO, and technology',
}
          ...
          <footer className="border-t border-gray-200 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              <div className="text-center">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">John's Blog</h3>
                <p className="text-sm text-gray-600 mb-4">
                  Sharing thoughts on web development, SEO, and technology since 2024
                </p>
                ...
                <p className="text-xs text-gray-500">
                  &copy; {new Date().getFullYear()} John's Blog. All rights reserved.
                </p>
              </div>
            </div>
          </footer>
