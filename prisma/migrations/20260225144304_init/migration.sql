...
CREATE TABLE "SEOReport" (
    ...
    "imageAltScore" INTEGER NOT NULL,
    "slugScore" INTEGER NOT NULL,
    "keywordPresence" JSONB,
    "suggestions" JSONB,
...
-- CreateIndex
CREATE UNIQUE INDEX "SEOReport_postId_key" ON "SEOReport"("postId");
...
-- AddForeignKey
ALTER TABLE "SEOReport" ADD CONSTRAINT "SEOReport_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("id") ON DELETE CASCADE ON UPDATE CASCADE;
